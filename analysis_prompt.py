...
def build_analysis_prompt(
    ...
    return (
        ...
        f"{role_instruction}\n\n"
        f"{base}\n\n"
        "This is an educational orientation tool. It does not provide a medical diagnosis, "
        "treatment recommendation, or triage decision. Include a clear medical disclaimer in "
        "your response stating that a qualified healthcare professional must review the findings. "
