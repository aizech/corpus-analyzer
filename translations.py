...
UI_TEXTS: Dict[str, Dict[str, str]] = {
    ...
    "body_back_head": {"en": "Head / neck (back)", "de": "Kopf / Nacken (hinten)"},
    "body_front_neck": {"en": "Neck (front)", "de": "Hals (vorne)"},
    "body_back_neck": {"en": "Neck (back)", "de": "Nacken (hinten)"},
    "body_chest": {"en": "Chest", "de": "Brust"},
    "body_abdomen": {"en": "Abdomen", "de": "Bauch"},
    "body_pelvis": {"en": "Pelvis / groin (front)", "de": "Becken / Leiste (vorne)"},
    "body_upper_back": {"en": "Upper back", "de": "Oberer Rücken"},
    "body_lower_back": {"en": "Lower back", "de": "Unterer Rücken"},
    "body_buttock": {"en": "Buttock", "de": "Gesäß"},
    "body_left_shoulder": {"en": "Left shoulder", "de": "Linke Schulter"},
    "body_right_shoulder": {"en": "Right shoulder", "de": "Rechte Schulter"},
    "body_left_upper_arm": {"en": "Left upper arm", "de": "Linker Oberarm"},
    "body_right_upper_arm": {"en": "Right upper arm", "de": "Rechter Oberarm"},
    "body_left_forearm": {"en": "Left forearm", "de": "Linker Unterarm"},
    "body_right_forearm": {"en": "Right forearm", "de": "Rechter Unterarm"},
    "body_left_elbow": {"en": "Left elbow", "de": "Linker Ellbogen"},
    "body_right_elbow": {"en": "Right elbow", "de": "Rechter Ellbogen"},
    "body_left_hand": {"en": "Left hand", "de": "Linke Hand"},
    "body_right_hand": {"en": "Right hand", "de": "Rechte Hand"},
    "body_left_index_finger": {"en": "Left index finger", "de": "Linker Zeigefinger"},
    "body_right_index_finger": {"en": "Right index finger", "de": "Rechter Zeigefinger"},
    "body_left_middle_finger": {"en": "Left middle finger", "de": "Linker Mittelfinger"},
    "body_right_middle_finger": {"en": "Right middle finger", "de": "Rechter Mittelfinger"},
    "body_left_ring_finger": {"en": "Left ring finger", "de": "Linker Ringfinger"},
    "body_right_ring_finger": {"en": "Right ring finger", "de": "Rechter Ringfinger"},
    "body_left_little_finger": {"en": "Left little finger", "de": "Linker kleiner Finger"},
    "body_right_little_finger": {"en": "Right little finger", "de": "Rechter kleiner Finger"},
    "body_left_thumb": {"en": "Left thumb", "de": "Linker Daumen"},
    "body_right_thumb": {"en": "Right thumb", "de": "Rechter Daumen"},
    "body_left_thigh": {"en": "Left thigh", "de": "Linker Oberschenkel"},
    "body_right_thigh": {"en": "Right thigh", "de": "Rechter Oberschenkel"},
    "body_left_knee": {"en": "Left knee", "de": "Linkes Knie"},
    "body_right_knee": {"en": "Right knee", "de": "Rechtes Knie"},
    "body_left_calf": {"en": "Left calf", "de": "Linke Wade"},
    "body_right_calf": {"en": "Right calf", "de": "Rechte Wade"},
    "body_left_ankle": {"en": "Left ankle", "de": "Linker Knöchel"},
    "body_right_ankle": {"en": "Right ankle", "de": "Rechter Knöchel"},
    "body_left_foot": {"en": "Left foot", "de": "Linker Fuß"},
    "body_right_foot": {"en": "Right foot", "de": "Rechter Fuß"},
    "body_left_big_toe": {"en": "Left big toe", "de": "Linke große Zehe"},
    "body_right_big_toe": {"en": "Right big toe", "de": "Rechte große Zehe"},
    "body_left_fingernails": {"en": "Left fingernails", "de": "Linke Fingernägel"},
    "body_right_fingernails": {"en": "Right fingernails", "de": "Rechte Fingernägel"},
    "body_left_toenails": {"en": "Left toenails", "de": "Linke Zehennägel"},
    "body_right_toenails": {"en": "Right toenails", "de": "Rechte Zehennägel"},
    "body_other": {"en": "Other / not listed", "de": "Sonstige / nicht aufgeführt"},
    # Anamnesis
